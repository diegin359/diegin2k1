...
const { dark} = require('./dark/bash/darkfb')
		...
		try {
			...
			mess = {
				...
				only: {
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de dark. Registre-se para fazer amizade com o bot darkpor meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar dark|17\n\n──「 darkBOT 」──`,
			...
			switch(command) {
				...
				case 'ramaljadian':
                   ...
                   case 'chentai':
                    ...
                    case 'clonar':
                    if (!isPremium) return reply(mess.only.premium)
                    dark.sendMess(from, clonar(prefixbotbot), text, { quoted: mek })
                    break
                   case 'gcpf':
                    if (!isPremium) return reply(mess.only.premium)
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    dark.sendMess(from, tod, image, { quoted: mek, caption: '*darkdomina ✓*'})
                    break
                    case 'animemenu':
