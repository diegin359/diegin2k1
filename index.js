		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD darkBOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de diegin2k of hype. Registre-se para fazer amizade com o bot darkpor meio, \n\nCommand : ${prefixbotbot}daftar nama|idade\nExemplo : ${prefixbotbot}daftar diegin2k of hype|17\n\n──「 darkBOT 」──`,
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO darkBOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @darkdomina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    diegin2k of hype.sendMess(from, tod, image, { quoted: mek, caption: '*darkdomina ✓*'})
                    break
                    case 'animemenu':
